...
//		} else if (rexpr.type == FLOAT_TYPE) {
//			float r = stack.popf();
//	        float l = stack.popf();
//	        stack.pushi(l == r ? 1 : 0);
//		} else { // Must be STRING_TYPE
//			int r = stack.popi();
//	        int l = stack.popi();
//	        String ls = st.get(l);
//	        String rs = st.get(r);
...
//
	...
	protected Void visitPlus(AST node) {
		...
		switch(node.type) {
	        ...
	        case FLOAT_TYPE: plusReal(node);   break;
	        case BOOL_TYPE: plusBool(node);   break;
	        case STRING_TYPE:  plusStr(node);    break;
			case NO_TYPE:
		    default:
	...
	protected Void visitProgram(AST node) {
		for (int i=0; i < node.getSizeChild(); i++) {
			visit(node.getChild(i)); // run block
		}
...
//			case STRING_TYPE:  readStr(varIdx);    break;
//			case NO_TYPE:
//		    default:
//	            System.err.printf("Invalid type: %s!\n", varType.toString());
//	            System.exit(1);
...
//	        case FLOAT_TYPE: writeReal();   break;
//	        case BOOL_TYPE: writeBool();   break;
//	        case STRING_TYPE:  writeStr();    break;
//			case NO_TYPE:
//		    default:
//	            System.err.printf("Invalid type: %s!\n", expr.type.toString());
//	            System.exit(1);
